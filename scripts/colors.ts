...
export const VitesseThemes = {
  primary: ['#FFB6C1', '#1c6b48'],

  foreground: ['#dbd7caee', '#393a34'],
  activeForeground: ['#bfbaaa', '#4e4f47'],
  secondaryForeground: ['#8c71a3', '#393a3490'],
  ...
  selectionBackground: ['#eeeeee1e', '#22222218'],
  ...
  string: ['#4d9375', '#b56959'],
  variable: ['#6872ab', '#b07d48'],
  keyword: ['#00598a', '#1e754f'],
  number: ['#4C9A91', '#2f798a'],
  boolean: ['#4d9375', '#1e754f'],
  operator: ['#cb7676', '#ab5959'],
  function: ['#d38691', '#59873a'],
  constant: ['#c99076', '#a65e2b'],
  class: ['#C9B27C', '#5a6aa6'],
  interface: ['#5d99a9', '#2e808f'],
  type: ['#5DA994', '#2e8f82'],
  builtin: ['#ba8e2f', '#ab5959'],
  property: ['#2993a3', '#998418'],
